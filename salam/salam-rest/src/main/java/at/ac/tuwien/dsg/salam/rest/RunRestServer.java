package at.ac.tuwien.dsg.salam.rest;
...
public class RunRestServer {
    ...
    private static final String PROP_FILE = "config/salam-rest.properties";
    ...
    public static void main(final String[] args) throws Exception {
        ...
        String salamRestConfig = PROP_FILE;
        ...
        System.setProperty(AppConfig.SALAM_REST_CONFIG, salamRestConfig);
        ...
        System.out.println("SALAM REST server running at http://" + serverHost + ":" + serverPort + "/" + restContextPath);
